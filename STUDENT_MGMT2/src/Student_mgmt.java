...
public class Student_mgmt extends JFrame implements ActionListener {
    ...
    */
    ...
    public Student_mgmt() {
        ...
        lblAcct.setBounds(30, 150, 100, 30);
        add(lblAcct);
        
        txtAcct = new JTextField();
        txtAcct.setBounds(140, 150, 200, 30);
        add(txtAcct);
        
        // Buttons
        btnAdd = new JButton("Add");
        btnAdd.setBounds(30, 200, 90, 30);
        ...
        btnUpdate.setBounds(130, 200, 90, 30);
        btnUpdate.addActionListener(this);
        add(btnUpdate);

        btnDelete = new JButton("Delete");
        btnDelete.setBounds(230, 200, 90, 30);
        btnDelete.addActionListener(this);
        add(btnDelete);

        btnSearch = new JButton("Search");
        btnSearch.setBounds(330, 200, 90, 30);
        btnSearch.addActionListener(this);
        add(btnSearch);

        btnViewAll = new JButton("View All");
        btnViewAll.setBounds(180, 240, 120, 30);
        btnViewAll.addActionListener(this);
        add(btnViewAll);

        // Text Area
        textArea = new JTextArea();
        textArea.setBounds(30, 290, 400, 250);
        add(textArea);
...
//                System.out.println("LocalDate: '" + DOB + "'");
    ...
    public static void main(String[] args) {
        new Student_mgmt().setVisible(true);
    }
}
